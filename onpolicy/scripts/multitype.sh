...
#     so many baneling
env="StarCraft2"
map="1c3s5z" # USING SINGLE TYPE MAP WILL NOT WORK
algo="mappo"
exp="1c3s5z_multitype"
user_name="xavee" # CHANGE THIS TO YOUR OWN WANDB USERNAME
seed_max=1
n_rollout_threads=3
seed_max=2
